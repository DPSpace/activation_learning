...
def run_training():
    ...
    with tf.Graph().as_default():
        ...
        total_steps = 800000
        learning_value = 0.5  # 0.5 for augmentation
        ...
        for step in xrange(total_steps):
            ...
            if not FLAGS.nofeedback:
                ...
                sess.run(train_op, feed_dict={
                    ...
                    learning_rate_placeholder: -np.multiply(sample_rate * (learning_value * FLAGS.unlearning_factor), need_train)
                })
