...
def read_data_sets(train_dir,
    ...
    v_size = (len(train_images) - validation_size) // 5
    if v_size >= validation_size:
        v_size = validation_size
    validation_images = train_images[:v_size]
    validation_labels = train_labels[:v_size]
    #     validation_images = train_images[:v_size]
    #     validation_labels = train_labels[:v_size]
    # else:
    #     choice = numpy.random.choice(validation_size, v_size, replace=False)
    #     validation_images = train_images[choice]
    #     validation_labels = train_labels[choice]
